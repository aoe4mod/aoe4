 ...
 */
declare function AIProductionScoring_AmountOfResourceNeeded(aiPlayer: PlayerID, maxResources: number): any;
 ...
 */
declare function AIProductionScoring_DeficiencyScore(aiPlayer: PlayerID, weight: number): any;
 ...
 */
declare function AIProductionScoring_IncreaseOverTime(aiPlayer: PlayerID, minGameTime: number, increasePerSecond: number): any;
 ...
 */
declare function AIProductionScoring_LowResourceIncome(aiPlayer: PlayerID, resourceIncomePerSecond: number): any;
 ...
 */
declare function AIProductionScoring_MaximumGameTime(aiPlayer: PlayerID, maxGameTime: number): any;
 ...
 */
declare function AIProductionScoring_PresenceOfUpgradeableSquads(aiPlayer: PlayerID, weight: number): any;
 ...
 */
declare function AIProductionScoring_ResourceGeneratorScore(aiPlayer: PlayerID, depletionTimeThreshold: number): any;
 ...
 */
declare function AIProductionScoring_ShouldNotConsiderNaval(aiPlayer: PlayerID, shouldIncludeLimitedNaval: boolean): any;
 ...
 * For each player squad that this upgrade applies to the score is increased by the weight to a max of 1.0.
 */
declare function AIProductionScoring_TierUpgrade(aiPlayer: PlayerID, weight: number): any;
 ...
 * Keeps an item within limits. If groupPopulation == true then all members of the item's Production Group are counted towards the current population to be compared against the limit.
 */
declare function AIProductionScoring_UnderCountLimitFromStateModel(aiPlayer: PlayerID, keyMaxAlive: string): any;
 ...
 */
declare function AIProductionScoring_VehicleUnderCountLimit(aiPlayer: PlayerID, groupPopulation: boolean, maxCap: boolean): any;
 ...
 */
declare function EGroup_CallEntityFunction(egroup: EGroupID, entityFunction: any, argument: any): any;
 ...
 */
declare function EGroup_CallEntityFunctionAllOrAny(egroup: EGroupID, all: boolean, entityFunction: any, argument: any): any;
 ...
 */
declare function Formation_PlaceSquadsInFormationByFormationName(sgroup: SGroupID, position: Position, direction: Position, formationPBGNameShort: string): any;
 ...
 */
declare function Game_ScreenFade(r: number, g: number, b: number, a: number, timeSecs: number): any;
 ...
 */
declare function Modifier_ApplyToEntity(modifier: ScarModifier, entity: EntityID, durationSeconds: number): any;

/**
 * Applies a player modifier to a player. Use a duration of 0 for an indefinite modifier.
 */
declare function Modifier_ApplyToPlayer(modifier: ScarModifier, player: PlayerID, durationSeconds: number): any;

/**
 * Applies a squad modifier to a squad. Use a duration of 0 for an indefinite modifier.
 */
declare function Modifier_ApplyToSquad(modifier: ScarModifier, squad: SquadID, durationSeconds: number): any;
 ...
 */
declare function Modifier_Create(applicationType: ModifierApplicationType, modtype: string, usageType: ModifierUsageType, exclusive: boolean, value: number, v: any): any;
 ...
 */
declare function Obj_Create(player: PlayerID, title: string, desc: string, icon: string, dataTemplate: string, faction: string, type: ObjectiveType, parentID: number, telemetryTitle: string): any;
 ...
 */
declare function Obj_SetObjectiveFunction(id: number, fnType: ObjectiveFn, f: any): void;
 ...
 */
declare function PrintOnScreen_Add(object: any, id: string, OPT_style?: string): any;
 ...
 */
declare function Setup_SetPlayerRace(player: PlayerID, racePBG: ScarRacePBG): void;
 ...
 */
declare function SGroup_CallEntityFunction(sgroup: SGroupID, entityFunction: any, argument: any): any;
 ...
 */
declare function SGroup_CallSquadFunction(sgroup: SGroupID, squadFunction: any, argument: any): any;
 ...
 */
declare function SGroup_CallSquadFunctionAllOrAny(sgroup: SGroupID, all: boolean, squadFunction: any, argument: any): any;
 ...
 */
declare function SyncWeapon_IsAttacking(weapon: SyncWeaponID, time: number): any;
 ...
 */
declare function Table_GetRandomItem(table: any, OPT_numberofitems?: number): any;
 ...
 */
declare function UI_IsLayerContentLoaded(layer: FrontEnd_Layer, contentPath: string): any;
 ...
 */
declare function UI_MessageBoxSetButton(dialogResult: DialogResult, text: string, tooltip: string, icon: string, isEnabled: boolean): void;
 ...
 */
declare function UnitEntry_DeploySquads(player: PlayerID, sgroup: SGroupID, units: any, spawn: MarkerID | Position, OPT_entryMethod?: any, OPT_stagger?: number, OPT_options?: any): any;
 ...
 */
declare function World_SetTeamWin(winningTeam: number, winReason: number): void;
 ...
 */
declare function BP_GetEntityArchetypeBlueprintForPlayer(player: Player, index: FamilyIndex): any;

/**
 * Returns an entity blueprint of type BLUEPRINT_ARCHETYPE index for the associated race.
 */
declare function BP_GetEntityArchetypeBlueprintForRace(racePBG: ScarRacePBG, index: FamilyIndex): any;
 ...
 */
declare function BP_GetEntityBPDefaultSpeed(entityBag: ScarEntityPBG, getModifiedSpeed: boolean, player: PlayerID): any;
 ...
 */
declare function BP_GetPropertyBagGroupPathName(type: PropertyBagGroupType, index: number): any;
 ...
 */
declare function BP_GetSquadArchetypeBlueprintForPlayer(player: Player, index: FamilyIndex): any;

/**
 * Returns a squad blueprint of type BLUEPRINT_ARCHETYPE index for the associated race.
 */
declare function BP_GetSquadArchetypeBlueprintForRace(racePBG: ScarRacePBG, index: FamilyIndex): any;
 ...
 */
declare function EBP_PopulationCost(ebpUnit: PropertyBagGroup, player: PlayerID, type: CapType): any;
 ...
 */
declare function Camera_CatromSplinePanOverTime(var_: any, seconds: number, keepQueue: boolean, controlRotation: boolean): any;

/**
 * Moves the camera through a list of positions.
 */
declare function Camera_CyclePositions(list: any, OPT_pan?: boolean, OPT_panRate?: number, OPT_callback?: any): any;
 ...
 */
declare function Camera_LinearSplinePanOverTime(var_: any, seconds: number, keepQueue: boolean, controlRotation: boolean): any;

/**
 * Move the camera to an entity/marker/pos/egroup/sgroup/squad at a given speed
 */
declare function Camera_MoveTo(var_: any, pan: boolean, panRate: number, keepInputLocked: boolean, resetToDefault: boolean): any;
 ...
 */
declare function Camera_PanOverTimeRelative(delta: Position, seconds: number, keepQueue: boolean): any;
 ...
 */
declare function Camera_PanOverTimeTo(var_: any, seconds: number, keepQueue: boolean): any;
 ...
 */
declare function Cmd_Ability(user: EGroupID, blueprint: number, OPT_target?: EGroupID, OPT_direction?: Position, OPT_skipCostPrereq?: boolean, OPT_queued?: boolean): any;
 ...
 */
declare function Cmd_Attack(sgroup: SGroupID, target: EGroupID, OPT_queued?: boolean, OPT_stationary?: boolean, OPT_plan?: string, OPT_check?: boolean): any;
 ...
 */
declare function Cmd_AttackMove(sgroup: SGroupID, targetposition: Position, OPT_queued?: boolean, OPT_plan?: string, OPT_coverSearchRadius?: number, OPT_deleteOnArrival?: boolean, OPT_splitCmd?: boolean): any;
 ...
 */
declare function Cmd_Construct(sgroupid: SGroupID, blueprint: EntityID, targetid: EGroupID, OPT_Facing?: Position, OPT_queued?: boolean): any;
 ...
 */
declare function Cmd_InstantReinforceUnit(sgroup: SGroupID, count: number): any;
 ...
 */
declare function Cmd_InstantUpgrade(target: EGroupID, blueprint: number, OPT_count?: number): any;
 ...
 */
declare function Cmd_Move(sgroup: SGroupID, position: EGroupID, OPT_queued?: boolean, OPT_deleteOnArrival?: boolean, OPT_facing?: Position, OPT_offset?: number, OPT_distance?: number, OPT_coverSearchRadius?: number, OPT_splitCmd?: boolean): any;
 ...
 */
declare function Cmd_MoveAwayFromPos(sgroup: SGroupID, position: Position, radius: number, OPT_queued?: boolean): any;
 ...
 */
declare function Cmd_MoveToClosestMarker(sgroup: SGroupID, markertable: any): any;
 ...
 */
declare function Cmd_MoveToThenAttackMove(sgroup: SGroupID, position: EGroupID, OPT_distance?: number, OPT_ANY?: boolean, OPT_queued?: boolean): any;
 ...
 */
declare function Cmd_Retreat(sgroup: SGroupID, OPT_location?: Position, OPT_deleteOnArrival?: boolean, OPT_queued?: boolean, OPT_saveEncounters?: boolean, OPT_vulnerableRetreat?: boolean): any;
 ...
 */
declare function Cmd_SetDemolitions(sgroupid: SGroupID, targetid: EGroupID, OPT_skipCostPrereq?: boolean, OPT_queued?: boolean): void;
 ...
 */
declare function Cmd_SquadPath(sgroup: SGroupID, pathName: string, bFromClosest: boolean, loop: number, bAttackMove: boolean, pauseTime: number, OPT_queued?: boolean, OPT_bMoveForward?: boolean): any;
 ...
 */
declare function Cmd_StaggeredRetreat(sgroup: SGroupID, markers: any, OPT_maxTries?: number, OPT_vulnerableRetreat?: boolean): any;
 ...
 */
declare function Cmd_Surrender(sgroupid: SGroupID, OPT_actionpoints?: number, OPT_exitpos?: Position, OPT_deleteAtExit?: boolean, OPT_removeWeapon?: boolean): any;
 ...
 */
declare function Cmd_Upgrade(user: EGroupID, blueprint: number, OPT_count?: number, OPT_instant?: boolean): any;
 ...
 */
declare function Cmd_WalkToAndThenRun(sgroup: SGroupID, position: EGroupID, speedMultiplier: number, OPT_distance?: number, OPT_ANY?: boolean, OPT_queued?: boolean): any;
 ...
 */
declare function Core_WinnerlessGameOver(presentationFunction: any, reason: number): any;
 ...
 */
declare function Event_StartEx(eventFunction: any, int: number, onComplete: any): any;
 ...
 */
declare function Util_EnterCinematicMode(OPT_VisibilityFlag?: GameUICore, OPT_of?: List, skipNISCallback?: any, shouldKeepXboxHidden?: boolean): any;
 ...
 */
declare function EGroup_ContainsBlueprints(egroup: EGroupID, blueprint: EBP | EntityType | any, all: boolean): any;
 ...
 * Returns true if EGroup contains a particular EntityID
 */
declare function EGroup_ContainsEntityID(egroup: EGroupID, entity: EntityID): any;
 ...
 */
declare function EGroup_Filter(egroup: EGroupID, blueprint: string, filtertype: number, OPT_splitGroup?: EGroupID): any;

/**
 * Internal implementation of EGroup_Filter for the purposes of optional arguments. Don't use directly, use EGroup_Filter
 */
declare function EGroup_Filter_Internal(group: EGroupID, blueprints: any, filterType: ScarFilterType, optionalSplitGroup: any): any;
 ...
 */
declare function EGroup_FilterOnScreen(egroup: EGroupID, percent: number, filtertype: number): any;

/**
 * Filters EGroup with given name out of given EGroup into the resource EGroup.
 */
declare function EGroup_FilterResource(group: EGroupID, name: string, resource: EGroupID): any;

/**
 * Filters an EGroup by whether or not the entity is part of a squad. filter_type can be FILTER_KEEP or FILTER_REMOVE
 */
declare function EGroup_FilterSquads(egroup: EGroupID, filter_type: number): any;
 ...
 */
declare function EGroup_FilterUnderConstruction(egroup: EGroupID, filtertype: number): any;
 ...
 */
declare function EGroup_GetClosestEntityInternal(group: EGroupID, position: Vector3f): any;
 ...
 */
declare function EGroup_GetDeSpawnedEntityAt(group: EGroupID, int: number): any;
 ...
 */
declare function EGroup_GetOffsetPosition(egroup: EGroupID, offset: number, value: number): any;
 ...
 */
declare function EGroup_GetSpawnedEntityFilter(egroupid: EGroupID, condition: any): any;
 ...
 */
declare function EGroup_HasAbility(egroup: EGroupID, ability: number, all: boolean): any;
 ...
 */
declare function EGroup_HasBlueprint(egroup: EGroupID, blueprint: EBP | EntityType | any, all: boolean): any;
 ...
 */
declare function EGroup_IsDoingAttack(egroup: EGroupID, all: boolean, time: number): any;
 ...
 */
declare function EGroup_IsOnScreen(player: PlayerID, group: EGroupID, all: boolean, OPT_percent?: number): any;
 ...
 */
declare function EGroup_IsUnderAttack(egroup: EGroupID, all: boolean, time: number): any;

/**
 * Check if the entities are attacked by the player
 */
declare function EGroup_IsUnderAttackByPlayer(group: EGroupID, attackerplayer: PlayerID, duration: number): any;
 ...
 */
declare function EGroup_IsUnderAttackFromDirection(egroup: EGroupID, all: boolean, offset: number, time: number): any;
 ...
 */
declare function EGroup_NotifyOnPlayerDemolition(id: EGroupID, function_: any): any;
 ...
 */
declare function EGroup_RemoveAllMatching(group: EGroupID, grouptocompare: EGroupID): any;
 ...
 */
declare function EGroup_RemoveGroup(group: EGroupID, grouptoremove: EGroupID): any;
 ...
 */
declare function EGroup_SetAvgHealth(egroup: EGroupID, healthPercent: number): void;
 ...
 */
declare function EGroup_SetDemolitions(player: PlayerID, egroupid: EGroupID, OPT_numcharges?: number): void;
 ...
 */
declare function EGroup_SetInvulnerable(egroup: EGroupID, enabled: boolean, OPT_reset_time?: number): void;
 ...
 */
declare function EGroup_SetPlayerOwner(egroup: EGroupID, owner: PlayerID): void;
 ...
 */
declare function Entity_ActiveCommandIs(entity: EntityID, cmdtype: EntityCommandType): any;
 ...
 */
declare function Entity_AddResource(entity: EntityID, type: number, amount: number): any;
 ...
 */
declare function Entity_CalcConstructionPlacement(ebp: ScarEntityPBG, ructingPlayer: PlayerID, inputPosition: Position): any;
 ...
 */
declare function Entity_Create(ebp: ScarEntityPBG, player: PlayerID, pos: Position, snapToTerrain: boolean): any;
 ...
 */
declare function Entity_CreateFacing(ebp: ScarEntityPBG, player: PlayerID, pos: Position, toward: Position, snapToTerrain: boolean): any;
 ...
 */
declare function Entity_GetLastAttackers(entity: EntityID, group: SGroupID, timeSeconds: number): any;
 ...
 */
declare function Entity_GetOffsetPosition(entity: EntityID, offset: number, distance: number): any;
 ...
 */
declare function Entity_GetProductionQueueItem(entity: EntityID, index: number): any;
 ...
 */
declare function Entity_GetProductionQueueItemType(entity: EntityID, index: number): any;
 ...
 */
declare function Entity_GetResource(entity: EntityID, resourceType: number): any;
 ...
 */
declare function Entity_GetWeaponBlueprint(entity: EntityID, hardPointIndex: number): any;
 ...
 */
declare function Entity_HasBlueprint(entity: EntityID, blueprints: EBP | EntityType | any): any;
 ...
 */
declare function Entity_IsHardpointActive(entity: EntityID, hardPointIndex: number): any;
 ...
 */
declare function Entity_IsUnderAttackByPlayer(entity: EntityID, pAttackerOwner: PlayerID, time: number): any;

/**
 * Returns true if the entity was under attack from a certain direction (8 offset types, see ScarUtil.scar)
 */
declare function Entity_IsUnderAttackFromDirection(entity: EntityID, offset: number, timeSeconds: number): any;
 ...
 */
declare function Entity_NotifyOnPlayerDemolition(entity: EntityID, function_: any): any;
 ...
 */
declare function Entity_QueueProductionItemByPBG(entity: EntityID, itemType: ProductionItemType, pbg: PropertyBagGroup): any;
 ...
 */
declare function Entity_SetBurnExtEnabled(unit: EGroupID, enabled: boolean): void;
 ...
 */
declare function Entity_SetDemolitions(player: PlayerID, entity: EntityID, numcharges: number): void;
 ...
 */
declare function Entity_SetLockCurrentTierVisuals(entity: EntityID, lockVisuals: boolean): void;
 ...
 */
declare function Entity_SetResource(entity: EntityID, type: number, amount: number): void;
 ...
 */
declare function Entity_SuggestPosture(entity: EntityID, posture: number, duration: number): any;
 ...
 */
declare function FOW_RevealArea(pos: Position, radius: number, durationSecs: number): any;
 ...
 */
declare function FOW_RevealEGroup(group: EGroupID, radius: number, durationSecs: number): any;

/**
 * Reveals an entity group in the FOW for alive players for a duration.
 * Pass in a duration of -1 for an indefinite duration.
 */
declare function FOW_RevealEGroupOnly(group: EGroupID, durationSeconds: number): any;
 ...
 */
declare function FOW_RevealEntity(entity: EntityID, radius: number, durationSecs: number): any;
 ...
 * Pass in a duration of -1 for indefinite duration ( until the squads are dead or UnReveal is called )
 */
declare function FOW_RevealSGroup(group: SGroupID, radius: number, durationSecs: number): any;

/**
 * Reveals a squad group in the FOW for alive players for a duration.
 * Pass in a duration of -1 for an indefinite duration.
 */
declare function FOW_RevealSGroupOnly(group: SGroupID, durationSeconds: number): any;
 ...
 */
declare function FOW_RevealSquad(squad: SquadID, radius: number, durationSecs: number): any;

/**
 * Reveals a territory to a player
 */
declare function FOW_RevealTerritory(player: PlayerID, sectorID: number, durationSecs: number, mustOwn: boolean): any;
 ...
 */
declare function FOW_UnRevealTerritory(player: PlayerID, sectorID: number): any;
 ...
 */
declare function Modify_AbilityCastTime(player: PlayerID, ability: AbilityID, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies the channeling time of an ability
 */
declare function Modify_AbilityChannelingTime(player: PlayerID, ability: AbilityID, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies the initial delay time of an ability
 */
declare function Modify_AbilityDelayTime(player: PlayerID, ability: AbilityID, scalefactor: number): any;

/**
 * Modifies the duration of an ability
 */
declare function Modify_AbilityDurationTime(player: PlayerID, ability: AbilityID, scalefactor: number): any;

/**
 * Modifies the manpower cost of an ability
 */
declare function Modify_AbilityManpowerCost(player: PlayerID, ability: AbilityID, scalefactor: number, OPT_mathtype?: number): any;
 ...
 */
declare function Modify_AbilityMaxCastRange(player: PlayerID, ability: AbilityID, scalefactor: number): any;
 ...
 */
declare function Modify_AbilityMinCastRange(player: PlayerID, ability: AbilityID, scalefactor: number): any;

/**
 * Modifies the munitions cost of an ability
 */
declare function Modify_AbilityMunitionsCost(player: PlayerID, ability: AbilityID, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies the recharge time of an ability
 */
declare function Modify_AbilityRechargeTime(player: PlayerID | EntityID | SquadID, ability: AbilityID, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies a squad or entity's armor
 */
declare function Modify_Armor(group: EGroupID, scalefactor: number, OPT_exclusive?: boolean): any;

/**
 * Modifies the capture time of all strategic points in an EGroup.
 */
declare function Modify_CaptureTime(egroup: EGroupID, scalefactor: number): any;

/**
 * Modifies the capture time of all cover objects in an EGroup.  Higher = less time to capture.
 */
declare function Modify_CoverCaptureTime(egroup: EGroupID, scalefactor: number): any;
 ...
 */
declare function Modify_EntityBuildTime(playerId: PlayerID, ebp: string, scalefactor: number): any;

/**
 * Modifies an entity's construction time
 * Should only be used on entities, NOT squads
 */
declare function Modify_EntityConstructionTime(group: EGroupID, Factor: number, Usage: MUT): any;

/**
 * Modifies the cost of an entity (or squad) blueprint for a particular player.
 */
declare function Modify_EntityCost(player: PlayerID, blueprint: string, resourceType: number, scalefactor: number, mathtype: number, OPT_exclusive?: boolean): any;
 ...
 * Should only be used on entities, NOT squads
 */
declare function Modify_EntitySelectionName(group: EGroupID, value: number, Usage: MUT): any;

/**
 * Modifies the veterancy experience received by a player
 */
declare function Modify_PlayerExperienceReceived(player: PlayerID, factor: number): any;

/**
 * Modifies the production rate of a player.
 */
declare function Modify_PlayerProductionRate(sgroup: PlayerID, scalefactor: number): any;

/**
 * Modifies a player's resource cap. Possible math types are MUT_Multiplication, MUT_Addition.
 */
declare function Modify_PlayerResourceCap(playerId: PlayerID, resourceType: number, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies a player's incoming resource rate. Possible math types are MUT_Multiplication, MUT_Addition.
 */
declare function Modify_PlayerResourceRate(playerId: PlayerID, resourceType: number, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies the sight radius for a player.
 */
declare function Modify_PlayerSightRadius(player: PlayerID, scalefactor: number): any;

/**
 * Modifies the upkeep for a player's resource.  Possible math types are MUT_Multiplication, MUT_Addition.
 */
declare function Modify_PlayerUpkeep(playerId: PlayerID, resourceType: number, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies the production rate of all factories in an EGroup
 */
declare function Modify_ProductionRate(sgroup: EGroupID, scalefactor: number): any;

/**
 * Modifies the build time for a particular upgrade. This only affects the given player.
 */
declare function Modify_ProductionSpeed(entity: EntityID, scalefactor: number): any;

/**
 * Modifies a projectile's delay_detonate_time.
 */
declare function Modify_ProjectileDelayTime(player: PlayerID, entityBP: PBG, factor: number): any;

/**
 * Modifies the chance of a squad/entity being hit
 */
declare function Modify_ReceivedAccuracy(group: EGroupID, scalefactor: number, OPT_exclusive?: boolean): any;

/**
 * Modifies the damage a squad/entity receives.
 */
declare function Modify_ReceivedDamage(group: EGroupID, scalefactor: number, OPT_exclusive?: boolean): any;

/**
 * Modifies the rate at which a squad gets suppressed
 */
declare function Modify_ReceivedSuppression(sgroup: SGroupID, scalefactor: number): any;
 ...
 */
declare function Modify_SquadAvailability(player: PlayerID, blueprint: string, addition: number): any;

/**
 * Modifies a squad's rate at which it will capture a strategic point.
 */
declare function Modify_SquadCaptureRate(group: SGroupID, scalefactor: number): any;
 ...
 */
declare function Modify_SquadTypeSightRadius(player: PlayerID, blueprint: string, scalefactor: number): any;
 ...
 */
declare function Modify_TerritoryRadius(group: EGroupID, scalefactor: number): any;
 ...
 */
declare function Modify_UnitVeterancyValue(group: EGroupID, scalefactor: number, OPT_mathtype?: number): any;

/**
 * Modifies the build time for a particular upgrade. This only affects the given player.
 */
declare function Modify_UpgradeBuildTime(playerId: PlayerID, upgrade: UpgradeID, scalefactor: number): any;

/**
 * Modifies the cost of an upgrade for a particular player.
 */
declare function Modify_UpgradeCost(playerId: PlayerID, upgrade: UpgradeID, resourceType: number, scalefactor: number, mathtype: number, OPT_exclusive?: boolean): any;

/**
 * Modifies the vehicle repair rate of all a player's engineers
 */
declare function Modify_VehicleRepairRate(player: PlayerID, factor: number, engineer_entity_blueprint: string): any;

/**
 * Modifies the vehicle rotation speed
 */
declare function Modify_VehicleRotationSpeed(group: EGroupID, factor: number): any;

/**
 * Modifies the turret rotation speed of a vehicle squad
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_VehicleTurretRotationSpeed(group: EGroupID, hardpoint: string, scalefactor: number): any;
 ...
 */
declare function Modify_Vulnerability(group: EGroupID, scalefactor: number): any;

/**
 * Modifies a squad's weapon accuracy.
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponAccuracy(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon burst length (time).
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponBurstLength(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon rate of fire.
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponBurstRateOfFire(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon cooldown time.
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponCooldown(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon damage.
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponDamage(group: EGroupID, hardpoint: string, scalefactor: number): any;
 ...
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponPenetration(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon range. Does not work on artillery (mortar, nebelwerfer, etc.)
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponRange(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon reload time.
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponReload(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon scatter.
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponScatter(group: EGroupID, hardpoint: string, scalefactor: number): any;

/**
 * Modifies a squad's weapon suppression. Does not work on artillery (mortar, nebelwerfer, etc.)
 * The hardpoint should be specified as a string - i.e. "hardpoint_01"
 */
declare function Modify_WeaponSuppression(group: EGroupID, hardpoint: string, scalefactor: number): any;
 ...
 */
declare function NIS_StartDrift(OPT_totalTime?: number, OPT_driftScale?: number): any;
 ...
 */
declare function Objective_AddAreaHighlight(objTable: any, pos: Marker | Position | Group, OPT_areatype?: AreaType, OPT_scale?: number, OPT_color?: any, OPT_alpha?: number): any;
 ...
 */
declare function Objective_AddGroundReticule(objTable: any, position: Marker | Position, OPT_size?: number, OPT_reticuleBlueprint?: BP, OPT_hintpointTemplate?: string): any;
 ...
 */
declare function Objective_AddHealthBar(objTable: any, group: EGroupID, OPT_onlyWhenDamaged?: boolean, OPT_barIndex?: number, OPT_text?: string): any;
 ...
 */
declare function Objective_AddTimerBar(objTable: any, OPT_barIndex?: number, OPT_text?: string): any;
 ...
 */
declare function Objective_AddUIElements(objTable: any, pos: Position, OPT_ping?: boolean, OPT_hintpointText?: string, OPT_worldArrow?: boolean, OPT_objectiveArrowOffset?: number, OPT_objectiveArrowFacing?: EntityID | Squad | Position, OPT_actionType?: number, OPT_iconName?: string, OPT_templateName?: string): any;
 ...
 */
declare function Objective_AreSubObjectivesComplete(objTable: any, all: boolean): any;

/**
 * Returns whether ALL or ANY sub-objectives of the given objective are expired
 */
declare function Objective_AreSubObjectivesExpired(objTable: any, all: boolean): any;

/**
 * Returns whether ALL or ANY sub-objectives of the given objective are failed
 */
declare function Objective_AreSubObjectivesFailed(objTable: any, all: boolean): any;
 ...
 */
declare function Objective_BlinkUIElements(objTable: any, elementID: number): any;
 ...
 */
declare function Objective_Complete(objTable: any, OPT_showTitle?: boolean, OPT_playIntel?: boolean): any;
 ...
 */
declare function Objective_Expire(objTable: any, OPT_showTitle?: boolean, OPT_playIntel?: boolean): any;
 ...
 */
declare function Objective_Fail(objTable: any, OPT_showTitle?: boolean, OPT_playIntel?: boolean): any;
 ...
 */
declare function Objective_IncreaseCounter(objTable: any, OPT_amount?: number): any;
 ...
 */
declare function Objective_Register(objTable: any, OPT_owner?: PlayerID | TeamID): any;
 ...
 */
declare function Objective_RemoveHealthBar(objectiveTable: any, healthBarID: Element): any;

/**
 * Removes a tactical map ping from an objective
 */
declare function Objective_RemovePing(objectiveTable: any, PingID: number): any;
 ...
 */
declare function Objective_RemoveTimerBar(objectiveTable: any, timerBarID: Element): any;

/**
 * Removes a group of UI elements that were added by Objective_AddUIElements
 */
declare function Objective_RemoveUIElements(objTable: any, elementID: number): any;
 ...
 */
declare function Objective_SetCounter(objTable: any, current: number, OPT_maximum?: number): void;
 ...
 */
declare function Objective_Show(objective_table: any, on: boolean, ShowTitle: boolean): any;
 ...
 */
declare function Objective_Start(objTable: any, OPT_showTitle?: boolean, OPT_playIntel?: boolean): any;

/**
 * Starts a timer that is associated with this objective in the UI. Use COUNT_DOWN or COUNT_UP for the 'direction' parameter
 */
declare function Objective_StartTimer(objTable: any, direction: number, OPT_initialTime?: number, OPT_flashThreshold?: number): any;
 ...
 */
declare function Objective_UpdateText(objTable: any, new_title: string, new_description: string, OPT_showTitle?: boolean, OPT_immediate?: boolean): any;
 ...
 */
declare function Player_AddResource(playerId: PlayerID, resourceType: number, value: number): any;
 ...
 */
declare function Player_AddUnspentCommandPoints(player: Player, points: number): any;
 ...
 */
declare function Player_CanConstructOnPosition(player: PlayerID, sgroupid: SGroupID, ebp: EntityID, targetid: EGroupID, OPT_Facing?: Position): any;
 ...
 */
declare function Player_GetAllEntitiesNearMarker(playerid: PlayerID, egroup: EGroupID, position: MarkerID | Position | SectorID, OPT_range?: number): any;
 ...
 * You can override a marker's normal proximity by specifying a range.
 */
declare function Player_GetAllSquadsNearMarker(player: PlayerID, sgroup: SGroupID, position: MarkerID | Position | SectorID, OPT_range?: number): any;

/**
 * Returns the entityID of the first player owned building listed in the table.
 * This only looks at completed buildings
 */
declare function Player_GetBuildingID(player: PlayerID, entitytypes: number): any;
 ...
 */
declare function Player_GetBuildingsCountExcept(playerId: PlayerID, exceptions: number): any;

/**
 * Returns the number of buildings owned by this player (inclusive).
 */
declare function Player_GetBuildingsCountOnly(playerId: PlayerID, ebplist: number): any;

/**
 * Returns the entityID of the first player owned building listed in the table.
 * This only looks at under construction buildings
 */
declare function Player_GetBuildingUnderConstructionID(player: PlayerID, entitytypes: number): any;
 ...
 */
declare function Player_GetCurrentPopulationCap(player: Player, capType: CapType): any;
 ...
 */
declare function Player_GetEntityConcentration(player: PlayerID, OPT_popcapOnly?: boolean, OPT_includeBlueprints?: any, OPT_excludeBlueprints?: any, OPT_bLeastConcentrated?: boolean, OPT_onlyInThisMarker?: MarkerID | any): any;
 ...
 */
declare function Player_GetMaxPopulationCap(player: Player, capType: CapType): any;
 ...
 */
declare function Player_GetMaxPopulationCapOverride(player: Player, capType: CapType): any;
 ...
 */
declare function Player_GetPopulationPercentage(playerid: PlayerID, OPT_captype?: number): any;
 ...
 * This function is slow, so don't call it very often
 */
declare function Player_GetSquadConcentration(player: PlayerID, OPT_popcapOnly?: boolean, OPT_includeBlueprints?: any, OPT_excludeBlueprints?: any, OPT_bLeastConcentrated?: boolean, OPT_onlyInThisMarker?: MarkerID | any): any;
 ...
 */
declare function Player_HasBuilding(player: PlayerID, entitytypes: number): any;

/**
 * Returns true if this player owns any buildings. (with exclusions).
 */
declare function Player_HasBuildingsExcept(playerId: PlayerID, exceptions: number): any;

/**
 * Returns true if this player owns any buildings listed in the table currently under construction.
 */
declare function Player_HasBuildingUnderConstruction(player: PlayerID, entitytypes: number): any;
 ...
 */
declare function Player_RestrictAddOnList(playerid: PlayerID, addonlist: any): any;

/**
 * Restrict a list of buildings.
 * list should contain an array of strings to restrict.
 */
declare function Player_RestrictBuildingList(playerid: PlayerID, blueprintlist: any): any;
 ...
 */
declare function Player_SetAbilityAvailability(player: PlayerID, bp: number, availability: number): void;
 ...
 */
declare function Player_SetCommandAvailability(player: PlayerID, command: number, availability: number): void;
 ...
 */
declare function Player_SetConstructionMenuAvailability(player: PlayerID, menuname: string, availability: number): void;

/**
 * Set default squad mood mode which can be overrided by squad level mood mode settings
 */
declare function Player_SetDefaultSquadMoodMode(player: Player, mood: SquadCombatBehaviourMoodMode): void;
 ...
 */
declare function Player_SetEntityProductionAvailability(player: PlayerID, bp: number, availability: number): void;
 ...
 */
declare function Player_SetPopCapOverride(player: Player, personnel: number): void;
 ...
 */
declare function Player_SetResource(player: Player, type: number, amt: number): void;
 ...
 */
declare function Player_SetSquadProductionAvailability(player: PlayerID, bp: number, availability: number): void;
 ...
 */
declare function Player_SetUpgradeAvailability(player: PlayerID, bp: number, availability: number): void;
 ...
 */
declare function Actor_PlaySpeech(actor: ActorTable, locID: number, OPT_speechbubble?: SGroupID, OPT_audioCtrlEvent?: string): any;

/**
 * Plays a speech event for a given actor WITHOUT a portrait or subtitle. See Actor_PlaySpeech for more details
 */
declare function Actor_PlaySpeechWithoutPortrait(actor: ActorTable, locID: number, OPT_speechbubble?: SGroupID, OPT_audioCtrlEvent?: string): any;
 ...
 */
declare function Prox_AreEntitiesNearMarker(egroup: EGroupID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number): any;
 ...
 */
declare function Prox_ArePlayerEntitiesNearMarker(player: PlayerID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number, OPT_filterlist?: EBP | any, OPT_filtertype?: number, OPT_ignore_camouflage?: boolean): any;
 ...
 * You MUST specify a range if you are using a position rather than a marker.
 */
declare function Prox_ArePlayerMembersNearMarker(player: PlayerID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number, OPT_filterlist?: SBP | any, OPT_filtertype?: number, OPT_ignore_camouflage?: boolean): any;
 ...
 * You MUST specify a range if you are using a position rather than a marker.\n Markers with proximity type rectangle will use circular proximity check if custom range is supplied\n
 */
declare function Prox_ArePlayersNearMarker(player: PlayerID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number, OPT_filterlist?: SBP | any, OPT_filtertype?: number, OPT_ignore_camouflage?: boolean): any;
 ...
 * You MUST specify a range if you are using a position rather than a marker.\n Markers with proximity type rectangle will use circular proximity check if custom range is supplied\n
 */
declare function Prox_AreSquadMembersNearMarker(sgroup: SGroupID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number): any;

/**
 * Returns true if ANY or ALL squads from a group are in range of a given position, marker, or territory sector
 * You MUST specify a range if you are using a position rather than a marker.\n Markers with proximity type rectangle will use circular proximity check if custom range is supplied\n
 */
declare function Prox_AreSquadsNearMarker(sgroup: SGroupID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number): any;
 ...
 * You MUST specify a range if you are using a position rather than a marker.\n Markers with proximity type rectangle will use circular proximity check if custom range is supplied\n
 */
declare function Prox_AreTeamsNearMarker(team: TeamID, position: MarkerID | Position | SectorID, all: boolean, OPT_range?: number, OPT_filterlist?: SBP | any, OPT_filtertype?: number, OPT_ignore_camouflage?: boolean): any;
 ...
 */
declare function Prox_EntitiesInProximityOfEntities(egroup1: EGroupID, egroup2: EGroupID, proximity: number, all: boolean): any;
 ...
 */
declare function Prox_GetRandomPosition(item: any, radius: number, minimum: number): any;
 ...
 * Set "all" to true to check that ALL entities are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerEntitiesInProximityOfEntities(playerid: PlayerID, egroup: EGroupID, proximity: number, all: boolean, exclude: EntityID): any;

/**
 * Checks if ALL or ANY players entities are in proximity of a given squad group.
 * Set "all" to true to check that ALL entities are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerEntitiesInProximityOfPlayerSquads(playerentities: PlayerID, playersquads: PlayerID, proximity: number, all: boolean): any;

/**
 * Checks if ALL or ANY players entities are in proximity of a given squad group.
 * Set "all" to true to check that ALL entities are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerEntitiesInProximityOfSquads(playerid: PlayerID, sgroup: SGroupID, proximity: number, all: boolean): any;

/**
 * Checks if ALL or ANY players squads are in proximity of a given entity group.
 * Set "all" to true to check that ALL squads are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerSquadsInProximityOfEntities(playerid: PlayerID, egroup: EGroupID, proximity: number, all: boolean, filterlist: SBP | any, filtertype: number, ignore_camouflage: boolean): any;

/**
 * Checks if ALL or ANY players squads are in proximity of a given players entities.
 * Set "all" to true to check that ALL squads are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerSquadsInProximityOfPlayerEntities(playersquads: PlayerID, playerentities: PlayerID, proximity: number, all: boolean): any;

/**
 * Checks if ALL or ANY players squads are in proximity of a given players squads.
 * Set "all" to true to check that ALL squads are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerSquadsInProximityOfPlayerSquads(playerid1: PlayerID, playerid2: PlayerID, proximity: number, all: boolean): any;

/**
 * Checks if ALL or ANY players squads are in proximity of a given squad group.
 * Set "all" to true to check that ALL squads are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_PlayerSquadsInProximityOfSquads(playerid: PlayerID, sgroup: SGroupID, proximity: number, all: boolean, exclude: SquadID, filterlist: SBP | any, filtertype: number, ignore_camouflage: boolean): any;
 ...
 * Set "all" to true to check that ALL squads are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_SquadsInProximityOfEntities(sgroup: SGroupID, egroup: EGroupID, proximity: number, all: boolean): any;

/**
 * Checks if ALL or ANY squads are in proximity of a given squad group.
 * Set "all" to true to check that ALL squads are in proximity, or set "all" to false to check for ANY.
 */
declare function Prox_SquadsInProximityOfSquads(sgroup1: SGroupID, sgroup2: SGroupID, proximity: number, all: boolean): any;
 ...
 */
declare function Rule_AddEGroupEvent(rule: any, egroup: EGroupID, eventtype: number): any;

/**
 * Add a rule to be executed when the event of 'eventType' has happened on the 'entity'
 * Event types are: GE_EntityKilled, GE_EntityParadropComplete, GE_EntityCommandIssued, GE_ProjectileFired, GE_AbilityExecuted, GE_SpawnActionComplete
 */
declare function Rule_AddEntityEvent(rule: any, entity: EntityID, eventtype: number): any;
 ...
 */
declare function Rule_AddEventFilter_EntityBlueprint(rule: any, context: RuleFilterContext, op: RuleFilterOperator, includeTypes: AnyArray, excludeTypes: AnyArray): any;
 ...
 */
declare function Rule_AddEventFilter_EntityPlayerOwner(rule: any, context: RuleFilterContext, op: RuleFilterOperator, includeTypes: AnyArray, excludeTypes: AnyArray): any;
 ...
 * Valid contexts are dependent on the event this filter is applied to. When multiple filters exist op defines how the result of the previous filter is combined with this filter.
 */
declare function Rule_AddEventFilter_EntityType(rule: any, context: RuleFilterContext, op: RuleFilterOperator, includeTypes: AnyArray, excludeTypes: AnyArray): any;
 ...
 * Valid contexts are dependent on the event this filter is applied to. When multiple filters exist op defines how the result of the previous filter is combined with this filter.
 */
declare function Rule_AddEventFilter_StateModelBool(rule: any, context: RuleFilterContext, op: RuleFilterOperator, includeTypes: AnyArray, excludeTypes: AnyArray): any;
 ...
 */
declare function Rule_AddInterval(f: any, interval: number | any, OPT_data?: any, OPT_group?: EGroupID): any;

/**
 * Add a rule to be executed once, after 'delay' seconds.
 * Returns the ID of the rule just added.
 */
declare function Rule_AddOneShot(rule: any, OPT_delay?: number, OPT_data?: any, OPT_group?: EGroupID): any;
 ...
 */
declare function Rule_AddPlayerEvent(rule: any, player: PlayerID, eventtype: number): any;
 ...
 */
declare function Rule_AddSGroupEvent(rule: any, sgroup: SGroupID, eventtype: number): any;

/**
 * Add a rule to be executed when the event of 'eventType' has happened on the 'squad'
 * Event types are: GE_SquadKilled, GE_SquadPinned, GE_SquadParadropComplete, GE_SquadCommandIssued, GE_AbilityExecuted, GE_SpawnActionComplete
 */
declare function Rule_AddSquadEvent(rule: any, squad: SquadID, eventtype: number): any;
 ...
 */
declare function Rule_EnterProximity(f: any, all: boolean, who: EGroupID, where: Marker, OPT_range?: number, OPT_recur?: boolean, OPT_data?: any): any;
 ...
 */
declare function Rule_ExitProximity(f: any, all: boolean, who: EGroupID, where: Marker, OPT_range?: number, OPT_recur?: boolean, OPT_data?: any): any;
 ...
 */
declare function Rule_GroupCount(f: any, group: EGroupID, comparison: Comparison, value: number, recur: boolean, data: any): any;
 ...
 */
declare function Rule_WhileInProximity(f: any, all: boolean, who: EGroupID, where: Marker, OPT_range?: number, OPT_interval?: number, OPT_recur?: boolean, OPT_data?: any): any;
 ...
 */
declare function EGroup_FilterCamouflaged(sgroup: EGroupID, filtertype: number, OPT_splitEGroup?: EGroupID): any;
 ...
 */
declare function SGroup_AddResource(sgroup: SGroupID, resource: number, amount: number): any;
 ...
 */
declare function SGroup_AddSlotItemToDropOnDeath(groupid: SGroupID, itemid: number, drop_chance: number, exclusive: boolean): any;
 ...
 * Check if a group contains ALL or ANY of the blueprints.
 */
declare function SGroup_ContainsBlueprints(sgroup: SGroupID, blueprints: BP | any, all: boolean): any;
 ...
 */
declare function SGroup_ContainsSquad(group: SGroupID, SquadID: number, includeDespawned: boolean): any;
 ...
 */
declare function SGroup_Filter(sgroup: SGroupID, blueprint: SBP | SquadType | any, filtertype: number, OPT_splitSGroup?: SGroupID): any;
 ...
 */
declare function SGroup_FilterCamouflaged(sgroup: SGroupID, filtertype: number, OPT_splitSGroup?: SGroupID): any;

/**
 * Pass in a group and it will filter it down to the indicated number
 */
declare function SGroup_FilterCount(sgroup1: SGroupID, groupSize: number, OPT_splitSGroup?: SGroupID): any;
 ...
 */
declare function SGroup_FilterOnScreen(egroup: SGroupID, percent: number, filtertype: number): any;
 ...
 */
declare function SGroup_FilterThreat(sgroup: SGroupID, tableSBPs: any, OPT_bEmpty?: boolean): any;

/**
 * Filters an sgroup on spawned/despawned status. Use FILTER_KEEP to keep the spawned units (therefore removing the despawned), or FILTER_REMOVE to remove the spawned units (and keep the despawned).
 */
declare function SGroup_FilterVisibleToPlayer(sgroup: SGroupID, filtertype: number, OPT_splitSGroup?: SGroupID): any;
 ...
 */
declare function SGroup_GetClosestSquad(sgroupid: SGroupID, position: Marker | Position): any;
 ...
 */
declare function SGroup_GetLastAttacker(SGroupVictim: SGroupID, SGroupAttacker: SGroupID, OPT_seconds?: number): any;
 ...
 */
declare function SGroup_GetOffsetPosition(sgroup: SGroupID, offset: number, value: number): any;
 ...
 */
declare function SGroup_HasAbility(sgroup: SGroupID, ability: number, all: boolean): any;
 ...
 */
declare function SGroup_HasSquadBlueprint(sgroup: SGroupID, blueprint: SBP | SquadType | any, all: boolean): any;
 ...
 */
declare function SGroup_IncreaseVeterancyExperience(groupid: SGroupID, experience: number, OPT_silent?: boolean, OPT_applyModifiers?: boolean): any;
 ...
 */
declare function SGroup_IncreaseVeterancyRank(groupid: SGroupID, OPT_numranks?: number, OPT_silent?: boolean): any;
 ...
 */
declare function SGroup_IsDoingAttack(sgroup: SGroupID, all: boolean, time: number): any;
 ...
 */
declare function SGroup_IsOnScreen(player: PlayerID, group: SGroupID, all: boolean, OPT_percent?: number): any;
 ...
 */
declare function SGroup_IsUnderAttack(sgroup: SGroupID, all: boolean, time: number): any;

/**
 * Check if the squads are attacked by the player
 */
declare function SGroup_IsUnderAttackByPlayer(group: SGroupID, attackerplayer: PlayerID, duration: number): any;
 ...
 */
declare function SGroup_IsUnderAttackFromDirection(sgroup: SGroupID, all: boolean, offset: number, time: number): any;
 ...
 * Set all to true to check for ALL or set to false to check for ANY
 */
declare function SGroup_IsUpgrading(sgroup: SGroupID, blueprint: number, all: boolean): any;
 ...
 */
declare function SGroup_RewardActionPoints(sgroup: SGroupID, actionpoint: number): any;
 ...
 */
declare function SGroup_SetAutoTargetting(group: SGroupID, hardpoint: number, enable: boolean): void;

/**
 * Sets the health of each squad in a squad group to a given percent [0.0, 1.0].
 */
declare function SGroup_SetAvgHealth(sgroup: SGroupID, healthpercent: number): void;

/**
 * Sets the moral of each squad in a squad group to a given percent [0.0, 1.0].
 */
declare function SGroup_SetAvgMorale(sgroup: SGroupID, moralepercent: number): void;
 ...
 */
declare function SGroup_SetInvulnerable(sgroup: SGroupID, enabled: boolean, OPT_reset_time?: number): void;
 ...
 */
declare function SGroup_SetSelectable(sgroupid: SGroupID, selectable: boolean): void;
 ...
 * Posture of 0 is prone, 1 is kneel/crouch, and 2 is standing.  Duration is in seconds, negative means indefinite.
 */
declare function SGroup_SuggestPosture(sgroup: SGroupID, posture: number, duration: number): any;
 ...
 */
declare function Squad_AddSlotItemToDropOnDeath(squad: SquadID, pbg: ScarSlotItemPBG, dropChance: number, exclusive: boolean): any;
 ...
 */
declare function Squad_CreateAndSpawnToward(sbp: ScarSquadPBG, player: PlayerID, loadoutCount: number, pos: Position, toward: Position): any;
 ...
 */
declare function Squad_FindCover(squad: SquadID, pos: Position, coverSearchRadius: number): any;
 ...
 */
declare function Squad_FindCoverCompareCurrent(squad: SquadID, pos: Position, coverSearchRadius: number, maxPathDistanceFromGoal: number, compareToCurrentCover: boolean): any;
 ...
 */
declare function Squad_GetLastAttackers(squad: SquadID, group: SGroupID, timeSeconds: number): any;
 ...
 */
declare function Squad_GetOffsetPosition(squad: SquadID, offset: number, distance: number): any;
 ...
 * Returns the blueprint for a production queue item with index.
 */
declare function Squad_GetProductionQueueItem(squad: SquadID, index: number): any;

/**
 * Returns the production type (PITEM_Upgrade, PITEM_Spawn, PITEM_SquadUpgrade, PITEM_SquadReinforce, PITEM_PlayerUpgrade) for a production queue item with index.
 */
declare function Squad_GetProductionQueueItemType(squad: SquadID, index: number): any;
 ...
 */
declare function Squad_GiveSlotItemsFromTable(squadid: SquadID, itemTable: any): any;
 ...
 */
declare function Squad_HasBlueprint(squad: SquadID, blueprints: SBP | SquadType | any): any;
 ...
 */
declare function Squad_IncreaseVeterancyRank(squad: SquadID, numranks: number, silent: boolean): any;
 ...
 * Time is in seconds
 */
declare function Squad_IsUnderAttackByPlayer(squad: SquadID, pAttackerOwner: PlayerID, time: number): any;

/**
 * Returns true if the squad was under attack from a certain direction (8 offset types, see ScarUtil.scar)
 */
declare function Squad_IsUnderAttackFromDirection(squad: SquadID, offset: number, timeSeconds: number): any;
 ...
 */
declare function Squad_RewardActionPoints(squad: SquadID, actionPoint: number): any;
 ...
 */
declare function Squad_SetMoodMode(squad: SquadID, mood: SquadCombatBehaviourMoodMode): void;

/**
 * Sets the squad's move type
 */
declare function Squad_SetMoveType(squad: SquadID, movetypePBG: ScarMoveTypePBG): void;
 ...
 */
declare function Squad_SetPosition(squad: SquadID, pos: Position, positionFacingToward: Position): void;
 ...
 */
declare function Squad_SetResource(squad: SquadID, resourceType: number, newAmount: number): void;
 ...
 */
declare function Squad_SuggestPosture(squad: SquadID, posture: number, duration: number): any;
 ...
 */
declare function Timer_GetMinutesAndSeconds(getTimeFunction: any, TimerID: number): any;
 ...
 */
declare function Game_SubTextFade(location: string, time: string, detail: string, in_: number, lifetime: number, out: number): any;
 ...
 */
declare function HintMouseover_Add(hintText: string, hintTarget: EGroupID, targetRadius: number, looping: boolean): any;
 ...
 */
declare function HintPoint_Add(where: any, bVisible: boolean, hintText: string, OPT_height?: number, OPT_actionType?: number, OPT_iconName?: string, OPT_priority?: number, OPT_visibleInFOW?: boolean, OPT_dataTemplate?: string): any;
 ...
 */
declare function HintPoint_SetDisplayOffset(hintpointID: number, x: number, y: number, OPT_z?: number): void;
 ...
 */
declare function Misc_AddEntitiesToGroup(group: EGroupID, entityIDsEncoded: string, includeSquads: boolean): any;
 ...
 */
declare function Misc_AddSquadsToGroup(group: SGroupID, entityIDsEncoded: string): any;
 ...
 */
declare function Misc_GetControlGroupContents(groupIndex: number, squads: SGroupID, nonSquadEntities: EGroupID): any;
 ...
 */
declare function Misc_GetHiddenPositionOnPath(checkType: number, origin: Position, destination: Position, ebpID: number, stepDistance: number, cameraPadding: number, FOWPlayer: PlayerID, debugDisplay: boolean): any;
 ...
 */
declare function Misc_SetEntityControlGroup(entity: EntityID, groupIndex: number): void;
 ...
 */
declare function Misc_SetSquadControlGroup(squad: SquadID, groupIndex: number): void;
 ...
 */
declare function ThreatArrow_Add(GroupID: number, Threat: EGroupID, OPT_icon?: string): any;
 ...
 */
declare function ThreatArrow_CreateGroup(dataTemplate: string, target1: Marker | Position | EntityID | Squad | Group, OPT_target2?: Marker | Position | EntityID | Squad | Group): any;
 ...
 */
declare function UI_AddHintAndFlashAbility(playerid: PlayerID, abilityID: AbilityID, text: string, length: number, OPT_blueprint_filter?: number): any;
 ...
 */
declare function UI_CreateEntityKickerMessage(entity: Target, message: Localized, path: Relative, path2: Relative, on: Position, on2: Position): any;
 ...
 */
declare function UI_CreateEventCueClickable(customEventType: number, lifetime: number, repeatCount: number, repeatTime: number, title: string, description: string, dataTemplate: string, iconPath: string, soundPath: string, red: number, green: number, blue: number, alpha: number, visibility: EventCueVisibility, function_: any): any;
 ...
 */
declare function UI_CreateEventCueClickableCanQueue(customEventType: number, lifetime: number, repeatCount: number, repeatTime: number, title: string, description: string, dataTemplate: string, iconPath: string, soundPath: string, red: number, green: number, blue: number, alpha: number, visibility: EventCueVisibility, function_: any): any;

/**
 * Creates a blip on the minimap; return the ID of the blip.
 * 'where' can be an entity, marker, position, egroup, sgroup, or squad.
 */
declare function UI_CreateMinimapBlip(where: any, lifetime: number, blipDataTemplate: string): any;
 ...
 */
declare function UI_CreatePositionKickerMessage(position: Target, message: Localized, path: Relative, path2: Relative, of_: number, on: Position, on2: Position): any;
 ...
 * Only works if the tuning_simulation->ui->kicker_settings->custom_entity is enabled.
 */
declare function UI_CreateSimpleEntityKickerMessage(entity: Target, message: Localized): any;

/**
 * Create a simple text only kicker message on the given position.
 * Only works if the tuning_simulation->ui->kicker_settings->custom_position is enabled.
 */
declare function UI_CreateSimplePositionKickerMessage(position: Target, message: Localized): any;
 ...
 */
declare function UI_CreateSimpleSquadKickerMessage(squad: Target, message: Localized): any;

/**
 * Create a custom kicker message on the given squad.
 * Only works if the tuning_simulation->ui->kicker_settings->custom_squad is enabled.
 */
declare function UI_CreateSquadKickerMessage(squad: Target, message: Localized, path: Relative, path2: Relative, of_: number, on: Position, on2: Position): any;
 ...
 */
declare function UI_EnableResourceTypeKicker(resourceType: number, enable: boolean): any;
 ...
 */
declare function UI_FlashEventCue(eventCueID: number, stopOnClick: boolean): any;
 ...
 */
declare function UI_FlashObjectiveIcon(objectiveID: number, stopOnClick: boolean): any;
 ...
 * Call UI_TitleDestroy to remove.
 */
declare function UI_ScreenFade(r: number, g: number, b: number, a: number, duration: number, persistent: boolean): any;
 ...
 */
declare function UI_SetSGroupSpecialLevel(sgroup: SGroupID, level: number): void;

/**
 * Enables or disables the silhouettes for squads / entities
 */
declare function UI_SetSilhouetteEnabled(unit: EGroupID, enabled: boolean): void;
 ...
 */
declare function WinWarning_PublishLoseReminder(player: PlayerID, warningLevel: number): any;
 ...
 */
declare function Game_EndSP(win: boolean, OPT_winReason?: number, OPT_nis?: boolean, OPT_sandmap?: boolean): any;
 ...
 */
declare function Modify_OnFireDamagePerTick(egroup: EGroupID, mathtype: ModifierUsageType, value: number): any;

/**
 * Modify the amount that the burn level decays per tick when not on fire
 */
declare function Modify_OnFireDecayAmountPerTick(egroup: EGroupID, mathtype: ModifierUsageType, value: number): any;

/**
 * Modify the health threshold required to set the entity on fire
 */
declare function Modify_OnFireHealthPercentage(egroup: EGroupID, mathtype: ModifierUsageType, value: number): any;

/**
 * Modify the burn level threshold required to set the entity on fire. A LOWER value means it lights on fire FASTER.
 */
declare function Modify_OnFireThreshold(egroup: EGroupID, mathtype: ModifierUsageType, value: number): any;
 ...
 * This function is slow, so don't call it very often
 */
declare function Team_GetEntityConcentration(team: TeamID, OPT_popcapOnly?: boolean, OPT_includeBlueprints?: any, OPT_excludeBlueprints?: any, OPT_bLeastConcentrated?: boolean, OPT_onlyInThisMarker?: MarkerID | any): any;

/**
 * Finds the greatest (or least) concentration of squads owned by a team.
 * This function is slow, so don't call it very often
 */
declare function Team_GetSquadConcentration(team: TeamID, OPT_popcapOnly?: boolean, OPT_includeBlueprints?: any, OPT_excludeBlueprints?: any, OPT_bLeastConcentrated?: boolean, OPT_onlyInThisMarker?: MarkerID | any): any;
 ...
 */
declare function Util_ApplyModifier(groupid: EGroupID, modifier: string, scalefactor: number, mathtype: number, OPT_applytype?: number, OPT_exclusive?: boolean, OPT_targetname?: string): any;
 ...
 */
declare function Util_AutoNISlet(nisletType: number, intelEventTable: any, OPT_bFOWvisible?: boolean): any;
 ...
 */
declare function Util_AutoSave(OPT_waitUntilOutOfCombat?: boolean, OPT_onlyCareAboutCombatOnScreen?: boolean, OPT_maxWaitTime?: number): any;
 ...
 */
declare function Util_ClearWrecksFromMarker(position: MarkerID | Position | SectorID, OPT_range?: number, OPT_wrecksList?: any): any;
 ...
 */
declare function Util_CreateEntities(player: PlayerID, egroup: EGroupID, blueprintID: number, location: MarkerID | Position, numentities: number, OPT_toward?: MarkerID | Position, OPT_snapToGround?: boolean, OPT_skipForceConstruct?: boolean, OPT_useMarkerTransform?: boolean): any;
 ...
 */
declare function Util_CreateSquads(player: PlayerID, sgroup: SGroupID, sbp: number, spawn_point: EGroupID, OPT_destination?: Position, OPT_numsquads?: number, OPT_loadout?: number, OPT_attackmove?: boolean, OPT_dest_facing?: Position, OPT_upgrades?: number, OPT_spawn_facing?: Position, OPT_spawntype?: string): any;
 ...
 */
declare function Util_DifVar(difficultyVariables: any, OPT_difficulty?: number): any;
 ...
 */
declare function Util_FallBackToGarrisonBuilding(sgroupid: SGroupID, radius: number): any;
 ...
 */
declare function Util_ForceRetreatAll(sgroup: SGroupID, marker: Marker, deleteOnArrival: boolean, aiEncounterDisable: boolean): any;
 ...
 */
declare function Util_GarrisonNearbyBuilding(sgroup: SGroupID, pos: Position, radius: number, OPT_occupied?: boolean, OPT_filter?: SGroupID): any;
 ...
 * Can also filter out groups not to occupy
 */
declare function Util_GarrisonNearbyVehicle(sgroup: SGroupID, pos: Position, radius: number, OPT_occupied?: boolean, OPT_filter?: SGroupID): any;
 ...
 */
declare function Util_GetEntitiesByBP(sourcegroup: EGroupID, destgroup: EGroupID, ebp: number): any;
 ...
 */
declare function Util_GetOffsetPosition(pos: EGroupID, offset: number, distance: number): any;
 ...
 */
declare function Util_GetPositionAwayFromPlayer(pos: EGroupID, player: PlayerID, OPT_searchRadius?: number, OPT_distance?: number): any;
 ...
 */
declare function Util_GetPositionFromAtoB(a: MarkerID | Position, b: MarkerID | Position, distance: number): any;
 ...
 */
declare function Util_GetRandomPosition(OPT_range?: number, OPT_hidden?: boolean): any;
 ...
 */
declare function Util_GetSquadsByBP(sourcegroup: SGroupID, destgroup: SGroupID, sbp: number): any;
 ...
 */
declare function Util_MissionTitle(title: string, OPT_time_fade_in?: number, OPT_lifetime?: number, OPT_time_fade_out?: number): any;

/**
 * Calls UI_NewHUDFeature() as an IntelEvent. Will get queued as any other event. See UI_NewHUDFeature() for parameter details.
 */
declare function Util_NewHUDFeatureEvent(newHUDFeature: HUDFeatureType, featureText: string, featureIcon: string, duration: number): any;
 ...
 */
declare function Util_PlayMovie(name: string, OPT_fadeOut?: number, OPT_fadeIn?: number, OPT_onComplete?: any, OPT_delay?: number, OPT_onCompleteAfterMovie?: boolean): any;
 ...
 */
declare function Util_PrintObject(obj: any, OPT_max_depth?: number, OPT_data_type?: string, OPT_print_func?: any): any;
 ...
 */
declare function Util_SetPlayerCanSkipSequence(event: any, skippedCallback: any, noFadeIn: boolean, OPT_fadeInTime?: number): void;

/**
 * Sets the player owner for an entity, squad, egroup or sgroup. Also sets player owner of whatever is garrisoned inside them
 */
declare function Util_SetPlayerOwner(Object: EGroupID, owner: PlayerID, OPT_bApplyToSquadsHeld?: boolean): void;
 ...
 */
declare function Util_TriggerEvent(playerid: PlayerID, position: EGroupID, range: number, func: any, non_combat: boolean, onscreen_only: boolean, onscreen_duration: number): any;
 ...
 * Returns the number of entities found
 */
declare function World_GetAllEntitiesOfType(egroup: EGroupID, type: string): any;
 ...
 * Returns the number of entities found Owner type could be OT_Player, OT_Ally, OT_Enemy or OT_Neutral Entities belonging to a squad would not be added to the egroup
 */
declare function World_GetEntitiesNearPoint(player: PlayerID, egroup: EGroupID, pos: Position, radius: number, ownerType: OwnerType): any;

/**
 * Clears the egroup, then finds and adds entities within the territory sector to the egroup
 * Returns the number of entities found Owner type could be OT_Player, OT_Ally, OT_Enemy or OT_Neutral Entities belonging to a squad would not be added to the egroup
 */
declare function World_GetEntitiesWithinTerritorySector(player: PlayerID, egroup: EGroupID, inSectorID: number, ownerType: OwnerType): any;
 ...
 * Returns the number of entities found Entities belonging to a squad would not be added to the egroup
 */
declare function World_GetNeutralEntitiesNearPoint(egroup: EGroupID, pos: Position, radius: number): any;

/**
 * Find and add neutral entities within the territory sector to the egroup
 * Returns the number of entities found Entities belonging to a squad would not be added to the egroup
 */
declare function World_GetNeutralEntitiesWithinTerritorySector(egroup: EGroupID, sectorID: number): any;

/**
 * Return the number of entities of the same ebp in the sphere volume
 */
declare function World_GetNumEntitiesNearPoint(ebp: ScarEntityPBG, pos: Position, radius: number): any;
 ...
 */
declare function World_GetOffsetPosition(position: Position, heading: Position, offset: number, distance: number): any;
 ...
 */
declare function World_GetPossibleSquadsBlueprint(racePBG: ScarRacePBG, index: number): any;
 ...
 * Returns the number of squads found Owner type could be OT_Player, OT_Ally, OT_Enemy or OT_Neutral This function is faster if radius is small and/or number of squads to search for is large
 */
declare function World_GetSquadsNearPoint(player: PlayerID, sgroup: SGroupID, pos: Position, radius: number, ownerType: OwnerType): any;
 ...
 */
declare function World_GetSquadsWithinTerritorySector(player: PlayerID, sgroup: SGroupID, inSectorID: number, ownerType: OwnerType): any;
 ...
 */
declare function World_GetTeamTerritoryGaps(sectorID1: number, sectorID2: number, results: any): any;
 ...
 */
declare function World_IsTerritorySectorOwnedByPlayer(player: PlayerID, inSectorID: number): any;
 ...
 */
declare function World_PointPointProx(p1: Position, p2: Position, prox: number): any;
 ...
 */
declare function World_TeamTerritoryPointsConnected(team_index: number, p1: Position, p2: Position): any;
